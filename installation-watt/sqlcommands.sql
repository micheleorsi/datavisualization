...
-- easier
SELECT I1.zipcode AS ZIPCODE, ifnull(I2.trend, 0) AS TREND, P1."2010 Census Population" AS POPULATION, ifnull(I2.trend, 0)*1.0/P1."2010 Census Population" AS RATIO
FROM (SELECT zipcode, trend FROM installation GROUP BY zipcode) AS I1 
...
SELECT I1.zipcode AS ZIPCODE, ifnull(I2.trend, I1.TREND1) AS TREND, P1."2010 Census Population" AS POPULATION, ifnull(I2.trend, I1.TREND1)*1.0/P1."2010 Census Population" AS RATIO
